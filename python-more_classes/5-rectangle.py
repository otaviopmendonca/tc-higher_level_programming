...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        """Create a new Rectangle instance with optional dimensions."""
        self.width = width
        self.height = height
    ...
    def width(self, value):
        """Set the rectangle's width after validating the value."""
    ...
    def height(self, value):
        """Set the rectangle's height after validating the value."""
        if not isinstance(value, int):
    ...
    def __del__(self):
        """Print a farewell message when the rectangle instance is deleted."""
        print("Bye rectangle...")
